...
// ─── Card 1 inner visual — "Real information" rows ────────────────────────────
...
function RealInfoCardVisual(): ReactNode {
  return (
...
// ─── Card 2 inner visual — "Your permissions" ────────────────────────────────

function PermissionsCardVisual(): ReactNode {
  return (
...
// ─── Card 3 inner visual — "Intelligent suggestions" ─────────────────────────
...
function IntelligentSuggestionsCardVisual(): ReactNode {
  return (
...
// ─── Chat demo panel — animation constants ────────────────────────────────────
...
function ChatDemoPanel(): ReactNode {
    ...
    <>
      ...
      <div className="flex-1 overflow-y-auto scrollbar-none">
        <div className={`mx-auto flex h-full w-full max-w-[360px] flex-col lg:max-w-[720px] px-3 lg:px-6 transition-transform duration-500${isChat ? '' : ' -translate-y-48 lg:-translate-y-96'}`}>
          ...
          {/* Chips have border, branded color icons inside rounded rects              */}
          <AnimatePresence>
            {isHome && (
          ...
          {/* ── Meetings section — exact Attio structure ────────────────────────────── */}
          <AnimatePresence>
            {isHome && (
