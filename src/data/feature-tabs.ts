/**
 * Data for FeatureTabsSection.
 *
 * Images → /public/assets/images/platform/[page]/[tab-id].png
 * Use transparent-background PNGs so the dot-pattern backdrop shows through.
 */
...
export interface FeatureTabsContent {
  /** Inline heading + subtext shown above the tabs */
  heading: string
  subtext: string
...
export const DATA_PAGE_TABS: FeatureTabsContent = {
  heading: 'From data to decisions, instantly.',
  subtext:
    'Surface insights fast with reports built for how your business works.',
  ...
  tabs: [
    {
      ...
      description:
        'Stages, forecasts, win rates, and time to close—all tracked.',
    ...
    },
    {
      ...
      description:
        'Track MRR, ARR, churn, and expansion revenue in real time.',
    ...
    },
    {
      ...
      description:
        'Understand activation, retention, and feature adoption at a glance.',
